...
Files that are error-free end with the filename `_valid` and return error code **0** when validated with this script. However, files that contain errors return error code **1**.
